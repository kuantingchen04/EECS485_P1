...
<html lang="en">
  <head>
   ...
   <style>
  body {
    background-image: url("http://i.imgur.com/5fnUGrV.jpg");
  background-size:100%;
...
*/
  ...
  <body role="document">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li><a href="home.php">Home</a></li> 
            ...
            <li class="active"><a href="RecycleBin.php">Recycle Bin</a></li>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1>Recycle Bin</h1>
        <p>This is where your deleted files are</p>
             <!--  <p><a href="search_the_folder.html" class="btn btn-primary btn-lg" role="button">Search the folder &raquo;</a></p> -->
      <p><a href="clear_recycle_bin.php" class="btn btn-primary btn-lg" role="button">Clear Recycle Bin</a></p>
      </div>
