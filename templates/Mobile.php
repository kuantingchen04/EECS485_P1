...
<html lang="en">
  <head>
   ...
   <style>
  body {
    background-image: url("http://i.imgur.com/5VkFj1x.jpg");
  background-size:100%;
...
*/
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1>Mobile</h1>
        <p>This is where you store files for your mobile</p>
     ...
     $user_name='frank';
     $directory_name='Files/mobile_files/';
     //$directory_name='/files';
     $thumbnails_directory=$user_name.'_thumbnails/';
